...
const styles = StyleSheet.create({
  ...
  logoImage: { width: 200, height: 80, marginBottom: 16 },
  ...
  footerSection: { alignItems: 'center', marginTop: 28, paddingTop: 20, borderTopWidth: 1, borderTopColor: COLORS.border },
  footerPowered: { textAlign: 'center', color: COLORS.textMuted, fontSize: 10, marginBottom: 8, lineHeight: 15 },
  privacyLink: { color: COLORS.accent, fontSize: 12, fontWeight: '700', textDecorationLine: 'underline', marginBottom: 8 },
  footerVersion: { textAlign: 'center', color: COLORS.textLight, fontSize: 11 },
});
